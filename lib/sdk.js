 ...
 * setSubnodeOwner('hero.eth', 'sub', '0x123456789') */
export function setSubnameOwner(name, subname, newOwner) {
    let namehash = getNamehash(name);
...
export function setSubnameRecord(name, subname, newOwner, resolver, ttl) {
    let namehash = getNamehash(name);
